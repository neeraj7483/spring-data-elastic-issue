...
class SearchHitMapping<T> {
	...
	/**
	 * try to convert the SearchDocument instances to instances of the inner
	 * property class.
	 *
	 * @param searchHits {@link SearchHits} containing {@link Document} instances
	 * @param type       the class of the containing class
	 * @return a new {@link SearchHits} instance containing the mapped objects or
	 *         the original inout if any error occurs
	 */
	...
	/**
	 * find a {@link ElasticsearchPersistentEntity} following the property chain
	 * defined by the nested metadata
	 * 
	 * @param persistentEntity base entity
	 * @param nestedMetaData   nested metadata
	 * @return A {@link ElasticsearchPersistentEntityWithNestedMetaData} containing
	 *         the found entity or null together with the {@link NestedMetaData}
	 *         that has mapped field names.
	 */
