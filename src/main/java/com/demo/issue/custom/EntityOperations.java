...
/**
 * Common operations performed on an entity in the context of it's mapping
 * metadata.
 *
 * @author Mark Paluch
...
public class EntityOperations {
	...
	/**
	 * Creates a new {@link AdaptibleEntity} for the given bean and
	 * {@link ConversionService} and {@link RoutingResolver}.
	 *
	 * @param entity            must not be {@literal null}.
	 * @param conversionService must not be {@literal null}.
	 * @param routingResolver   the {@link RoutingResolver}, must not be
	 *                          {@literal null}
	...
	/**
	 * Determine index name and type name from {@link Entity} with {@code index} and
	 * {@code type} overrides. Allows using preferred values for index and type if
	 * provided, otherwise fall back to index and type defined on entity level.
	 *
	 * @param entity the entity to determine the index name. Can be {@literal null}
	 *               if {@code index} and {@literal type} are provided.
	 ...
	 *             {@link EntityOperations#determineIndex(Entity, String)}
	 */
	@Deprecated
	...
	/**
	 * Determine index name and type name from {@link ElasticsearchPersistentEntity}
	 * with {@code index} and {@code type} overrides. Allows using preferred values
	 * for index and type if provided, otherwise fall back to index and type defined
	 * on entity level.
	 *
	 * @param persistentEntity the entity to determine the index name. Can be
	 *                         {@literal null} if {@code index} and {@literal type}
	 *                         are provided.
	 * @param index            index name override can be {@literal null}.
	 * @param type             index type override can be {@literal null}.
	 * @return the {@link IndexCoordinates} containing index name and index type.
	 * @deprecated since 4.1, use
	 *             {@link EntityOperations#determineIndex(ElasticsearchPersistentEntity, String)}
	 */
	@Deprecated
	...
	interface Entity<T> {
		...
		/**
		 * Returns whether the entity is versioned, i.e. if it contains a version
		 * property.
		 *
		 * @return
		 */
		...
		/**
		 * Returns the value of the version if the entity has a version property,
		...
		/**
		 * Returns the {@link ElasticsearchPersistentEntity} associated with this
		 * entity.
		 *
		 ...
		 *
		 * @return
		 * @throws IllegalStateException if no {@link ElasticsearchPersistentEntity} is
	...
	interface AdaptibleEntity<T> extends Entity<T> {
		...
		/**
		 * Populates the identifier of the backing entity if it has an identifier
		 * property and there's no identifier currently present.
		 *
		 ...
		 *
		 * @return the current version or {@literal null} in case it's uninitialized or
		 *         the entity doesn't expose a version property.
		 */
		@Override
		@Nullable
		Number getVersion();
		...
		/**
		 * Returns whether there is a property with type SeqNoPrimaryTerm in this
		 * entity.
		 *
	...
	private static class MapBackedEntity<T extends Map<String, Object>> implements AdaptibleEntity<T> {
		 ...
		 * 
		 * @see
		 * org.springframework.data.elasticsearch.core.EntityOperations.Entity#getId()
		 */
		@Override
		public Object getId() {
		 ...
		 * 
		 * @see
		 * org.springframework.data.elasticsearch.core.EntityOperations.AdaptibleEntity#
		 * hasParent()
		 */
		@Override
		 ...
		 * @see
		 * org.springframework.data.elasticsearch.core.EntityOperations.AdaptibleEntity#
		 * populateIdIfNecessary(java.lang.Object)
		 */
		@Nullable
		@Override
		 ...
		 * 
		 * @see
		 * org.springframework.data.elasticsearch.core.EntityOperations.Entity#getBean()
		 */
		@Override
		public T getBean() {
			return map;
		 ...
		 * 
		 * @see
		 * org.springframework.data.elasticsearch.core.EntityOperations.Entity#isNew()
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.springframework.data.elasticsearch.core.EntityOperations.Entity#
		 * getPersistentEntity()
		 */
		@Override
	...
	/**
	 * Simple mapped entity without an associated
	...
	private static class SimpleMappedEntity<T extends Map<String, Object>> extends MapBackedEntity<T> {
		 ...
		 * 
		 * @see
		 * org.springframework.data.elasticsearch.core.EntityOperations.UnmappedEntity#
		 * getId()
		 */
		@Override
		public Object getId() {
